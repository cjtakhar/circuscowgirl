    ...
    return (
        <div className="about">
            ...
            <div className="about-container">
                <p className="about-paragraph">Kansas Carradine is a globally acclaimed professional horsewoman with a lifelong dedication to her craft. Since the age of 11, she has entertained audiences around the world, demonstrating her exceptional talents as a trick rider, roman rider, and lasso artist.</p>
